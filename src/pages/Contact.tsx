      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          <a
            ...
            className="bg-white rounded-xl p-6 sm:p-8 shadow-sm hover:shadow-lg transition-shadow group"
          >
            <div className="flex items-center mb-4">
              <div className="w-12 h-12 bg-terracotta-100 rounded-lg flex items-center justify-center mr-4">
              ...
              <div className="min-w-0 flex-1">
                <h3 className="text-xl font-semibold text-stone-900 group-hover:text-terracotta-600 transition-colors">
                  Email
                </h3>
                <p className="text-stone-600 break-words">kendallvmcrae@gmail.com</p>
              </div>
            </div>
          ...
          >
            <div className="flex items-center mb-4">
              <div className="w-12 h-12 bg-terracotta-100 rounded-lg flex items-center justify-center mr-4">
                <svg className="w-6 h-6 text-terracotta-600" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="text-stone-600">LinkedIn Profile</p>
              </div>
            </div>
            <p className="text-stone-600">
        ...
        {/* Additional Info */}
        <div className="bg-terracotta-50 rounded-xl p-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <span className="px-4 py-2 bg-white text-stone-700 rounded-lg font-medium">
